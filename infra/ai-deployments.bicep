...
var deepSeekRequested = contains(modelQuotaOverrides, 'DeepSeek-V3.2')
  ...
  : (quotaStrategy == 'minimize' ? 5 : quotaStrategy == 'manual' ? 10 : 10)  // Tertiary fallback reserve after GPT-5.4-mini (#411)
...
// NOTE (#241): dall-e-3 and other image generation models are not available in eastus2.
// Image generation requires a cross-region resource. Tracked in #241.
