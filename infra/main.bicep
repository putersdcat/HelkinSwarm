...
// Capacity helpers — keep the total requested deployment capacity within the configured ceiling.
...
var embeddingRequested = contains(modelQuotaOverrides, 'text-embedding-3-large')
  ...
  : (quotaStrategy == 'minimize' ? 50 : quotaStrategy == 'manual' ? 25 : 100)
var grokReasoningRequested = contains(modelQuotaOverrides, 'grok-4-1-fast-reasoning')
  ...
  : (quotaStrategy == 'minimize' ? 10 : quotaStrategy == 'manual' ? 5 : 20)
...
var gpt54Requested = contains(modelQuotaOverrides, 'gpt-5.4-mini')
  ...
  : (quotaStrategy == 'minimize' ? 5 : quotaStrategy == 'manual' ? 2 : 10)
